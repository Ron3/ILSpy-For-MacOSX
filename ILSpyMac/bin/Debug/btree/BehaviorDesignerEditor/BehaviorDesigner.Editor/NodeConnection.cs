...
namespace BehaviorDesigner.Editor
{
	...
	public class NodeConnection : ScriptableObject
	{
		...
		public void DrawConnection(Vector2 source, Vector2 destination, bool disabled)
		{
			...
			{
				Vector3[] expr_2E1_cp_0 = this.linePoints;
				int expr_2E1_cp_1 = i;
				expr_2E1_cp_0[expr_2E1_cp_1].x = expr_2E1_cp_0[expr_2E1_cp_1].x + 1f;
				Vector3[] expr_2FF_cp_0 = this.linePoints;
				int expr_2FF_cp_1 = i;
				expr_2FF_cp_0[expr_2FF_cp_1].y = expr_2FF_cp_0[expr_2FF_cp_1].y + 1f;
			}
			Handles.DrawPolyLine(this.linePoints);
		}
